        ...
        properties: {
          ...
          requestBody: {
            ...
            properties: {
              ...
              sepa_iban: { type: ['string', 'null'] },
              sepa_beneficiary_bic: { type: ['string', 'null'] },
              sepa_beneficiary_legal_name: { type: ['string', 'null'] },
              sepa_beneficiary_address_line_1: { type: ['string', 'null'] },
              sepa_beneficiary_address_line_2: { type: ['string', 'null'] },
              sepa_beneficiary_city: { type: ['string', 'null'] },
              sepa_beneficiary_state_province_region: { type: ['string', 'null'] },
              sepa_beneficiary_postal_code: { type: ['string', 'null'] },
              sepa_beneficiary_country: { type: ['string', 'null'] },
            },
            required: ['type', 'name'],
