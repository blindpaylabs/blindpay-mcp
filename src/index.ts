...
const toolDefinitionMap: Map<string, McpToolDefinition> = new Map([
  ...
  ["GetV1InstancesReceivers", {
    ...
    inputSchema: {"type":"object","properties":{"instance_id":{"type":"string","minLength":15,"maxLength":15},"limit":{"type":"string","enum":["10","50","100","200","500","1000"],"description":"Number of items to return"},"offset":{"type":"string","enum":["0","10","50","100","200","500","1000"],"description":"Number of items to skip"},"starting_after":{"type":"string","description":"A cursor for use in pagination. starting_after is an object ID that defines your place in the list."},"ending_before":{"type":"string","description":"A cursor for use in pagination. ending_before is an object ID that defines your place in the list."},"full_name":{"type":"string"},"receiver_name":{"type":"string"},"status":{"type":"string","enum":["verifying","approved","rejected","deprecated","pending_review","awaiting_contract","compliance_request"]},"receiver_id":{"type":"string"},"bank_account_id":{"type":"string"},"country":{"type":"string"}},"required":["instance_id"]},
    method: "get",
    pathTemplate: "/v1/instances/{instance_id}/receivers",
    executionParameters: [{"name":"instance_id","in":"path"},{"name":"limit","in":"query"},{"name":"offset","in":"query"},{"name":"starting_after","in":"query"},{"name":"ending_before","in":"query"},{"name":"full_name","in":"query"},{"name":"receiver_name","in":"query"},{"name":"status","in":"query"},{"name":"receiver_id","in":"query"},{"name":"bank_account_id","in":"query"},{"name":"country","in":"query"}],
    requestBodyContentType: undefined,
    securityRequirements: [{"Bearer":[]}]
  }],
  ...
  ["GetV1InstancesReceiversRfi", {
    ...
    description: `Returns the open (pending) RFI for this receiver, or 404 if none.`,
    inputSchema: {"type":"object","properties":{"instance_id":{"type":"string","minLength":15,"maxLength":15},"receiver_id":{"type":"string","minLength":15,"maxLength":15}},"required":["instance_id","receiver_id"]},
    method: "get",
  ...
  ["PostV1InstancesReceiversRfi", {
    ...
    description: `Submit a flat response object for the open RFI. Flips kyc_status back to verifying.`,
  ...
  ["PostV1InstancesReceiversBankAccountsOfframpWallets", {
    ...
    inputSchema: {"type":"object","properties":{"receiver_id":{"type":"string","minLength":15,"maxLength":15},"instance_id":{"type":"string","minLength":15,"maxLength":15},"bank_account_id":{"type":"string","minLength":15,"maxLength":15},"requestBody":{"type":"object","properties":{"external_id":{"type":["string","null"]},"network":{"type":"string","enum":["tron","solana"]}},"required":["network"],"description":"Create a new offramp wallet"}},"required":["receiver_id","instance_id","bank_account_id"]},
    method: "post",
    pathTemplate: "/v1/instances/{instance_id}/receivers/{receiver_id}/bank-accounts/{bank_account_id}/offramp-wallets",
    executionParameters: [{"name":"receiver_id","in":"path"},{"name":"instance_id","in":"path"},{"name":"bank_account_id","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["PostV1InstancesQuotesFx", {
    ...
    inputSchema: {"type":"object","properties":{"instance_id":{"type":"string","minLength":15,"maxLength":15},"requestBody":{"type":"object","properties":{"from":{"type":"string","enum":["USDC","USDT","USDB"]},"to":{"type":"string","enum":["BRL","USD","MXN","COP","ARS"]},"request_amount":{"type":"number","minimum":500,"description":"1000 represents 10.00, 2050 represents 20.50"},"currency_type":{"type":"string","enum":["sender","receiver"],"description":""}},"required":["from","to","request_amount","currency_type"],"description":"Check FX rate"}},"required":["instance_id"]},
    method: "post",
  ...
  ["GetV1InstancesPayouts", {
    ...
    inputSchema: {"type":"object","properties":{"instance_id":{"type":"string","minLength":15,"maxLength":15},"limit":{"type":"string","enum":["10","50","100","200","500","1000"],"description":"Number of items to return"},"offset":{"type":"string","enum":["0","10","50","100","200","500","1000"],"description":"Number of items to skip"},"starting_after":{"type":"string","description":"A cursor for use in pagination. starting_after is an object ID that defines your place in the list."},"ending_before":{"type":"string","description":"A cursor for use in pagination. ending_before is an object ID that defines your place in the list."},"receiver_id":{"type":"string","minLength":15,"maxLength":15},"status":{"type":"string","enum":["processing","failed","refunded","completed","on_hold"]},"receiver_name":{"type":"string"},"bank_account_id":{"type":"string"},"country":{"type":"string"},"payment_method":{"type":"string","enum":["wire","ach","pix","pix_safe","ted","spei_bitso","transfers_bitso","ach_cop_bitso","international_swift","rtp"]},"network":{"type":"string"},"token":{"type":"string"}},"required":["instance_id"]},
    method: "get",
    pathTemplate: "/v1/instances/{instance_id}/payouts",
    executionParameters: [{"name":"instance_id","in":"path"},{"name":"limit","in":"query"},{"name":"offset","in":"query"},{"name":"starting_after","in":"query"},{"name":"ending_before","in":"query"},{"name":"receiver_id","in":"query"},{"name":"status","in":"query"},{"name":"receiver_name","in":"query"},{"name":"bank_account_id","in":"query"},{"name":"country","in":"query"},{"name":"payment_method","in":"query"},{"name":"network","in":"query"},{"name":"token","in":"query"}],
    requestBodyContentType: undefined,
    securityRequirements: [{"Bearer":[]}]
  }],
  ...
  ["PostV1InstancesPayinQuotesFx", {
    ...
    description: `Get FX Rate`,
    inputSchema: {"type":"object","properties":{"instance_id":{"type":"string","minLength":15,"maxLength":15},"requestBody":{"type":"object","properties":{"from":{"type":"string","enum":["USDC","USDT","USDB","BRL","USD","MXN","COP","ARS"]},"to":{"type":"string","enum":["USDC","USDT","USDB","BRL","USD","MXN","COP","ARS"]},"request_amount":{"type":"number","minimum":500,"description":"1000 represents 10.00, 2050 represents 20.50"},"currency_type":{"type":"string","enum":["sender","receiver"],"description":""}},"required":["from","to","request_amount","currency_type"],"description":"Check FX rate"}},"required":["instance_id"]},
    method: "post",
  ...
  ["GetV1InstancesPayins", {
    ...
    inputSchema: {"type":"object","properties":{"instance_id":{"type":"string","minLength":15,"maxLength":15},"limit":{"type":"string","enum":["10","50","100","200","500","1000"],"description":"Number of items to return"},"offset":{"type":"string","enum":["0","10","50","100","200","500","1000"],"description":"Number of items to skip"},"starting_after":{"type":"string","description":"A cursor for use in pagination. starting_after is an object ID that defines your place in the list."},"ending_before":{"type":"string","description":"A cursor for use in pagination. ending_before is an object ID that defines your place in the list."},"receiver_id":{"type":"string","minLength":15,"maxLength":15},"status":{"type":"string","enum":["processing","on_hold","failed","refunded","completed"]},"receiver_name":{"type":"string"},"bank_account_id":{"type":"string"},"country":{"type":"string"},"payment_method":{"type":"string","enum":["ach","wire","pix","ted","spei","transfers","pse","international_swift","rtp"]},"network":{"type":"string"},"token":{"type":"string"}},"required":["instance_id"]},
    method: "get",
  ...
  ["PostV1InstancesTransferQuotes", {
    ...
    inputSchema: {"type":"object","properties":{"instance_id":{"type":"string","minLength":15,"maxLength":15},"requestBody":{"type":"object","properties":{"wallet_id":{"type":"string","minLength":15,"maxLength":15},"amount_reference":{"type":"string","enum":["sender","receiver"],"description":""},"cover_fees":{"type":["boolean","null"],"description":"If true, the sender will cover the fees. If false, the receiver will cover the fees."},"request_amount":{"type":"number","minimum":1,"description":"100 represents 1, 2050 represents 20.50"},"sender_token":{"type":"string","enum":["USDC","USDT","USDB"]},"receiver_wallet_address":{"type":"string","minLength":42,"maxLength":42},"receiver_token":{"type":"string","enum":["USDC","USDT","USDB"]},"receiver_network":{"type":"string","enum":["base","sepolia","arbitrum_sepolia","base_sepolia","arbitrum","polygon","polygon_amoy","ethereum","stellar","stellar_testnet","tron","solana","solana_devnet"]},"partner_fee_id":{"type":["string","null"],"minLength":15,"maxLength":15}},"required":["wallet_id","amount_reference","request_amount","sender_token","receiver_wallet_address","receiver_token","receiver_network"],"description":"Create a new quote"}},"required":["instance_id"]},
    method: "post",
  ...
  ["PostV1InstancesWebhookEndpoints", {
    ...
    inputSchema: {"type":"object","properties":{"instance_id":{"type":"string","minLength":15,"maxLength":15},"requestBody":{"type":"object","properties":{"url":{"type":"string","format":"uri"},"events":{"type":"array","items":{"type":"string","enum":["receiver.new","receiver.update","bankAccount.new","payout.new","payout.update","payout.complete","payout.partnerFee","blockchainWallet.new","payin.new","payin.update","payin.complete","payin.partnerFee","tos.accept","limitIncrease.new","limitIncrease.update","virtualAccount.new","virtualAccount.complete","transfer.new","transfer.update","transfer.complete","wallet.new","wallet.inbound"]}}},"required":["url","events"],"description":"Create a new webhook endpoint"}},"required":["instance_id"]},
    method: "post",
    pathTemplate: "/v1/instances/{instance_id}/webhook-endpoints",
    executionParameters: [{"name":"instance_id","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["GetV1AvailableBankDetails", {
    ...
    inputSchema: {"type":"object","properties":{"rail":{"type":"string","enum":["wire","ach","pix","pix_safe","ted","spei_bitso","transfers_bitso","ach_cop_bitso","international_swift","rtp"]}},"required":["rail"]},
    method: "get",
